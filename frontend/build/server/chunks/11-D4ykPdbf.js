...
const load = async ({ params, fetch }) => {
  const { userId } = params;
  const response = await ApiMain.serverFetchJsonResponse(fetch, `/users/${userId}/list-following-ids`, {
    method: "GET"
  });
...
//# sourceMappingURL=11-D4ykPdbf.js.map
